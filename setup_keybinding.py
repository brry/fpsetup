"""
- copy key_score.py + tasks.json to the exercise folder
- add the 'score' keybinding to VScode's keybindings.json
Originally generated by claude.ai Sonnet 4.6 Extended 2026-03-14
Not very tested yet - feedback is especially welcome!

For this to work later, open the main course folder in VSCode, not an individual exercise subfolder.
"""
...
# os.chdir("C:/Dropbox/HPI/fpsetup") # for REPL
if os.path.basename(os.getcwd()) != "fpsetup":
    print("Please run this script from the fpsetup folder.")
    sys.exit(1)
print("NOTE: this is the main course folder:", os.path.dirname(os.getcwd()))

# --- Copy key_score.py and tasks.json to the main course folder ---

os.makedirs("../.vscode", exist_ok=True)
shutil.copy2("key_score.py", "../key_score.py")
shutil.copy2("tasks.json", "../.vscode/tasks.json")
